...
Performance: {A}"""
        ...
        prefix += f" Your response should only contain the predicted {metric} in the format ## performance ##. You must not explain your choice! Answer accurately and as shortly as possible!"
